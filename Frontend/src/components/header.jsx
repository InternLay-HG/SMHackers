  ...
  return (
    <div className="flex bg-[#f6fffb] justify-between p-2.5 sm:p-3 md:p-3.5 lg:p-4 shadow-lg">
      ...
      {text === "Logout" ? (
        ...
        <Link to='/login'>
          <button className="flex px-2 py-1 md:px-3 md:py-1 lg:px-4 lg:py-2 text-xs md:text-sm lg:text-base items-center gap-2 bg-white rounded-md hover:bg-green-100 text-medic-green shadow-md">
            {text}
            <img src={login} alt="User Icon" className="w-3 h-3 md:w-4 md:h-4 lg:w-5 lg:h-5" />
          </button>
        </Link>
