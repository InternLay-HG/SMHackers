...
export const Button = React.forwardRef(
  ({ image = null, text, subtext1 = null, subtext2 = null, prop = null, color = 'bg-gray-300', onClick, children }, ref) => {
    return (
      <div className="h-10 sm:h-12 md:h-14 p-0">
        <button onClick={onClick ? onClick : undefined} type="submit" className="p-0" ref={ref}>
          <div className={`rounded-[15px] md:rounded-[20px] lg:w-[180px] ${color} flex items-center justify-center md:justify-around lg:h-16 lg:py-2 hover:ring-2 hover:ring-green-200`}>
            <div className="flex items-center p-1 lg:p-2">
              {image && <img className="h-9 w-9 sm:h-10 sm:w-10 lg:w-12 lg:h-12 p-2" src={image} alt="Image" />}
              <div className="text">
