    ...
    <div class="max-w-md w-full p-6">
      ...
      <form action="#" method="POST" class="space-y-4">
        ...
        <section className="flex justify-around gap-1">
          <Inputfield text={"First Name"} type={"text"} id={"first-name"}/>
          <Inputfield text={"Last name"} type={"text"} id={"last-name"}/>
        </section>
        <section className="flex justify-around gap-1">
          <div>
            <label for="country" className="block text-sm font-medium text-[#00693B]">Country</label>     
        
            <select id="country" name="country" className="mt-1 text-sm font-medium text-gray-500 p-2 w-full border rounded-md focus:border-[#00693c8d] focus:border-2 focus:outline-none  transition-colors duration-300">
        ...
        <div>
          <button type="submit" class="w-full bg-white p-2 rounded-md hover:bg-gray-8 hover:bg-green-100 text-medic-green shadow-md focus:shadow-lg focus:ring-offset-2 transition-colors duration-300">Sign Up</button>
        </div>
      </form>
      <div class="mt-4 text-sm text-gray-600 text-center">
