    ...
    <div className="flex h-screen">
      ...
      <div className="w-full bg-[#f6fffb] lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          <h1 className="text-3xl font-semibold mb-6 text-[#00693B] font-inter text-center">
            Sign Up
          </h1>
          ...
          <form action="/signup" method="POST" className="space-y-4">
            ...
            <div>
              {errorMessage !== "" ? (
                <div className="p-2 md:p-3 lg:p-4 bg-red-100 mb-4 rounded-md">
                  <p className="block text-sm font-medium text-[#f44646]">
                    {errorMessage}
                  </p>
                </div>
              ) : null}
