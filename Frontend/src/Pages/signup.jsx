...
export const Signup = () => {
   ...
   const loginWithGoogle = async (event) => {
    ...
    try {
      ...
      const userEmail = user.email; // Identifier (email)
        ...
        <div class="max-w-md w-full p-6">
          ...
          <div class="mt-4 flex flex-col lg:flex-row items-center justify-between">
            <div class="w-full mb-2 lg:mb-0">
              <button
                ...
                type="button"
                class="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200  hover:bg-gray-8 hover:bg-green-100 shadow-md focus:shadow-lg  transition-colors duration-300"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
          ...
          <form action="/signup" method="POST" class="space-y-4">
            ...
            <div>
              <label
                for="role"
                className="block text-sm font-medium text-[#00693B]"
              >
                Role
              </label>
              ...
              <select
                ...
                id="role"
                name="role"
                className="mt-1 text-sm font-medium text-gray-500 p-2 w-full border rounded-md focus:border-[#00693c8d] focus:border-2 focus:outline-none  transition-colors duration-300"
              >
              ...
              <button
                onClick={async (e) => {
                  ...
                  const response = await axios.post(
                    "https://smhackers.onrender.com:3000/api/v1/user/signup",
                    {
                      username,
                      firstName,
                      lastName,
